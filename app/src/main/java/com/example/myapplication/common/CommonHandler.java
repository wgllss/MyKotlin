...
//    }
//
//    public void handerMessage(final Map<String, HandlerListener> mHandlerListeners, final int msgWhat, final int msgArg1, final int msgArg2, final Object obj) {
...
//    }
//
//    public void handerMessage(final Map<String, HandlerListener> mHandlerListeners, final Message msg) {
//        if (handler != null && mHandlerListeners != null) {
//            handler.post(new Runnable() {
//                @Override
//                public void run() {
...
//     * @description:
//     */
//    public void NetWorkCall(final NetWorkCallListener mNetWorkCallListener, final CommonNetWorkExceptionToast mCommonNetWorkExceptionToast, final NetWorkMsg msg) {

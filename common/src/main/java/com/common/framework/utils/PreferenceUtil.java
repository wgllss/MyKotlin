...
public class PreferenceUtil {
    ...
    public void setMachiningpicking(int machiningpicking) {
        SpUtils.put(AppBuildConfig.getApplication(), "Machiningpicking", "Machiningpicking", machiningpicking);
    }
//    machiningpicking (integer, optional): 加工出入库需要分拣 1:开启 0:关闭 ,
    public int getMachiningpicking(int machiningpicking) {
        return (int) SpUtils.get(AppBuildConfig.getApplication(), "Machiningpicking", "Machiningpicking", machiningpicking);
    }
